...
namespace StreetSmartArcGISPro.AddIns.ViewModels
{
  internal class BookmarkDockpaneViewModel : DockPane, INotifyPropertyChanged
  {
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
    ...
    internal static void Show()
    {
      ...
      {
        var pane2 = FrameworkApplication.DockPaneManager.Find(DAML.Dockpane.esri_mapping_bookmarksManagerDockPane);
        pane2?.Activate();
      }
    }
