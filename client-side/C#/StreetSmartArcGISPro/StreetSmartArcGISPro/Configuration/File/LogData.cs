...
namespace StreetSmartArcGISPro.Configuration.File
{
  ...
  public class LogData
  {
    ...
    public static void Load()
    {
      ...
      {
        Write(EventType.Error, $"Street Smart: ({nameof(EventLog)}.cs) (SaveLogData) Failed to load log data: {ex} ");
      }
    }
    ...
    public void Save()
    {
      ...
      {
        Write(EventType.Error, $"Street Smart: ({nameof(EventLog)}.cs) (SaveLogData) Failed to save log data: {ex} ");
      }
    }
